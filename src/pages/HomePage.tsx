  ...
  return (
    ...
    <div className="min-h-svh">
      ...
      <main className="site-main">
        ...
        <SectionDivider variant="blend" from="hero" to="surface" />
        ...
        <SectionDivider variant="blend" from="bridge" to="surface" />
        ...
        <SectionDivider variant="blend" from="surface" to="burgundy" />
